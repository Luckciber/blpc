<?php
    ...
    $listaInventario = obtenerMantencionesConEstado();
    //$data = getInventario();
    //print_r($datos);
?>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Listar Consulta Mantenciones</h1>
                   
                    <p class="mb-4">Generar listado de los productos en mantenimiento.</p>
                    <!-- DataTales Example -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Descripción</th>    
                                            <th>Registro en Inventario</th>
                                            <th>Correlativo en mantención</th> 
                                            <th>Estado</th>                                           
                                            <th>Opciones</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach(json_decode($listaInventario) as $datos){
                                                $htmlFilaTabla= "
                                                    <tr>
    ...
    <!-- tabla scripts -->
    <script src="scripts/cambioTextosTablas.js"></script>
