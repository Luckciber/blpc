...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
    ...
    <img src="img/logo.png" alt="Logo" class="img-fluid" style="width: 50px;
                                                                                                    border-radius: 25px 25px 25px 25px;">
    </div>
    <div class="sidebar-brand-text mx-3">BLPC
...
<li class="nav-item">
    ...
    <div id="collapseReporte" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="disenoConsulta1.php">Filtro Reportes</a>
...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMantenciones"
        aria-expanded="true" aria-controls="collapseTwo">
        <i class="fas fa-fw fa-cog"></i>
        <span>Mantenciones</span>
    </a>
    <div id="collapseMantenciones" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
